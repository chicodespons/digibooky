...
public enum Role {
    ...
    LIBRARIAN(new ArrayList<>(List.of(GET_ALL_BOOKS, GET_BOOK_BY_ISBN, UPDATE_BOOK, REGISTER_BOOK,GET_BOOK_BY_TITLE, DELETE_BOOK, GET_BOOK_BY_AUTHOR, RETURN_BOOK, GET_ALL_LENT_BOOK_BY_MEMBER, GET_ALL_OVERDUE_BOOKS)));
